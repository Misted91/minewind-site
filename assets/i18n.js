  ...
  strings: {
    fr: {
      ...
      build: {
        ...
        suggestPlaceholder: 'Décris ton set : tank, mêlée, archer, mage, fire…',
        generate: 'Générer un set',
        suggestNote: 'Suggestion automatique approximative (mots-clés) — à ajuster ensuite.',
        generateConfirm: 'Remplacer le set actif par le set généré ?',
        setName: 'Nom du set',
        deleteSet: 'Supprimer',
    ...
    en: {
      ...
      build: {
        ...
        suggestPlaceholder: 'Describe your set: tank, melee, archer, mage, fire…',
        generate: 'Generate a set',
        suggestNote: 'Approximate keyword-based suggestion — fine-tune afterwards.',
        generateConfirm: 'Replace the active set with the generated one?',
        setName: 'Set name',
        deleteSet: 'Delete',
    ...
    de: {
      ...
      build: {
        ...
        suggestPlaceholder: 'Beschreibe dein Set: Tank, Nahkampf, Bogen, Magier, Feuer…',
        generate: 'Set generieren',
        suggestNote: 'Ungefährer, schlagwortbasierter Vorschlag — danach anpassen.',
        generateConfirm: 'Aktives Set durch das generierte ersetzen?',
        setName: 'Set-Name',
        deleteSet: 'Löschen',
    ...
    es: {
      ...
      build: {
        ...
        suggestPlaceholder: 'Describe tu set: tanque, cuerpo a cuerpo, arquero, mago, fuego…',
        generate: 'Generar un set',
        suggestNote: 'Sugerencia aproximada por palabras clave — ajústala después.',
        generateConfirm: '¿Reemplazar el set activo por el generado?',
    ...
    it: {
      ...
      build: {
        ...
        suggestPlaceholder: 'Descrivi il tuo set: tank, mischia, arciere, mago, fuoco…',
        generate: 'Genera un set',
        suggestNote: 'Suggerimento approssimativo per parole chiave — da rifinire.',
        generateConfirm: 'Sostituire il set attivo con quello generato?',
