...
window.__I18N_STRINGS__.en = {
  ...
  build: {
    ...
    market: 'Market offers for your missing essences',
    marketNone: 'No offer',
  ...
  trade: {
    ...
    priceAmount: 'Your price',
    priceUnit: 'Unit (d = dragon egg, s = stack, sh = shegg)',
    ...
    listings: 'Listings',
    myListings: 'My sales',
    othersListings: 'Other sellers',
    myEmpty: "You don't have any active listings right now.",
    ...
    authChoiceIntro: 'To sell, a moderator must verify your username. Do you already have a verified account, or is this your first time?',
    authCreate: 'Create an account',
    authCreateDesc: 'First time on the marketplace',
    authCreateIntro: 'Choose the username you will sell under and a way to reach you. A moderator will approve your request.',
    authLogin: 'Log in',
    authLoginDesc: 'I already have an account (new PC/browser)',
    authLoginIntro: 'Enter the username of your already-verified account to link this device. A moderator will confirm it is you.',
    authBack: '← Back',
    modModeCreate: 'New account',
    modModeLogin: 'Log in',
    modPseudoExists: 'username already verified — link it',
    modPseudoUnknown: 'username not found',
