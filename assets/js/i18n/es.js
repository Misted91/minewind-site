...
window.__I18N_STRINGS__.es = {
  ...
  build: {
    ...
    market: 'Ofertas del mercado para tus esencias que faltan',
  ...
  trade: {
    ...
    priceAmount: 'Tu precio',
    priceUnit: 'Unidad (d = dragon egg, s = stack, sh = shegg)',
    ...
    othersListings: 'Ventas de otros',
    myEmpty: 'No tienes ningún anuncio activo por ahora.',
    ...
    authChoiceIntro: 'Para vender, un moderador debe verificar tu usuario. ¿Ya tienes una cuenta verificada o es tu primera vez?',
    authCreate: 'Crear una cuenta',
    authCreateDesc: 'Primera vez en el mercado',
    authCreateIntro: 'Elige el usuario con el que venderás y un medio de contacto. Un moderador aprobará tu solicitud.',
    authLogin: 'Iniciar sesión',
    authLoginDesc: 'Ya tengo una cuenta (nuevo PC/navegador)',
    authLoginIntro: 'Indica el usuario de tu cuenta ya verificada para vincular este dispositivo. Un moderador confirmará que eres tú.',
    authBack: '← Volver',
    modModeCreate: 'Cuenta nueva',
    modModeLogin: 'Inicio de sesión',
    modPseudoExists: 'usuario ya verificado — vincular',
    modPseudoUnknown: 'usuario no encontrado',
